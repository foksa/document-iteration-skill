...
### [API Design Session](api-design.md)
...
### [Migration Planning Session](migration-plan.md)
...
1. **Iteration rounds** - Comment → response → refinement
1. **Decision tracking** - Using status tags
1. **Final cleanup** - Clean document ready for use
