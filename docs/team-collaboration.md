...
See [Customization](customization.md) for more configuration options.

## See Also

- [Customization](customization.md) - Configure team rules
- [First Iteration](first-iteration.md) - Basic workflow
- [Examples](index.md) - More patterns
